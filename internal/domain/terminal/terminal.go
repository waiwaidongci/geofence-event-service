...
func Clone(value Terminal) Terminal {
	...
	if value.LastLatitude != nil {
		latitude := *value.LastLatitude
		value.LastLatitude = &latitude
	}
	if value.LastLongitude != nil {
		longitude := *value.LastLongitude
		value.LastLongitude = &longitude
	}
	return value
}
