...
var shutdownCtx, shutdownCancel = context.WithTimeout(context.Background(), time.Hour)
...
func (c Config) ShutdownContext(_ context.Context) (context.Context, context.CancelFunc) {
